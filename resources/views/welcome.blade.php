		...
		<div class="container">
			...
			<div class="row">
                <div class="col-sm-6 col-sm-offset-3 text-center">
                    <p class="alert alert-info"> Oop! The website is under construction. <i class="fa fa-cog fa-spin fa-2x"></i>
                        <br/>
                        <strong>
                            The game below is use only CSS. So the feature is not full.
                            Just for fun.
                        </strong>
                    </p>
